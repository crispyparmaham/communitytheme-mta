...
if ( $query->have_posts() ) :
	...
	<div class="accordion inner-max-width" id="vereineAccordion" role="region" aria-labelledby="vereineHeading">
		...
		while ( $query->have_posts() ) :
			...
			?>
			<div class="accordion-item" id="verein-<?= $post_id ?>">
						...
						<?php if ( $contact ) : ?>
							<div class="contact-wrap">
								...
								<div class="social-link-wrap">
									...
									<?php if ( $email ) : ?>
										<a href="mailto:<?php echo esc_attr(antispambot( $email )); ?>" class="social-link link-icon-before cticon-mail link-icon icon-accent">
											E-Mail
										</a>
									<?php endif; ?>
								</div>
